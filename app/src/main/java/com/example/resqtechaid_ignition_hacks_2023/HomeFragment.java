...
public class HomeFragment extends Fragment {
    ...
    Button buttonScan, buttonContact, buttonLearnMore, buttonEmergency;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        buttonLearnMore = rootView.findViewById(R.id.buttonLearnMore);
        buttonEmergency = rootView.findViewById(R.id.buttonEmergency);
        ...
        buttonContact.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                // Toast.makeText(getActivity(), "Contact Button has been clicked", Toast.LENGTH_SHORT).show();
        ...
        buttonLearnMore.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                // Toast.makeText(getActivity(), "Learn More Button has been clicked", Toast.LENGTH_SHORT).show();
                replaceFragment(new LearnMoreFragment());
            }
        });
